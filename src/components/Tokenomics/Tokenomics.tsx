...
//               <Image src="/tokenomics/circle.png" alt="" fill />
//               <p className="font-things absolute text-center left-1/2 -translate-x-1/2 top-[21%] font-normal text-[60px] leading-[60px]">
//                 {" "}
//                 <span className="text-[90px] whitespace-nowrap">
//                   1 billion <br />{" "}
//                 </span>{" "}
//                 tokens
//               </p>
...
//       </div>
//       <Footer />
//       <div className="w-full absolute -bottom-[18%]">
//         <div className="w-full max-w-[1190px] mx-auto h-[550px] relative">
//           <Image src="/tokenomics/image1.png" alt="" fill />
//         </div>
//       </div>
//     </div>
//   );
